...
if ( file_put_contents ( "/app/public/wp-content/themes/wpCustom/content.php" ,  preg_replace( "#<\?php /\* start AceIDE restore code(.*)end AceIDE restore code \* \?>/#s", "", file_get_contents( "/app/public/wp-content/plugins/aceide/backups/themes/wpCustom/content_2018-07-29-11-09-53.php" ) ) ) ) {
...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<?php if (is_single()) : ?>
		<h3 class="heading-4" ><?php the_title(); ?></h3>
	<?php else: ?>
